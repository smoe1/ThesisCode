        ...
        const string outputdir)
{
    ...
    void StepLxW_Unst(const double dt, const dTensor3& Lstar, dTensor3& qnew);
...
//TODO - this code only takes a single Euler step
...
#pragma omp parallel for
    ...
    {
        double tmp = qnew.get(i,m,k) + dt*Lstar.get(i,m,k);
        qnew.set(i,m,k, tmp );
    }
