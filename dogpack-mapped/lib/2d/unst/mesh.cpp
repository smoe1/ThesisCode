...
const double& mesh::get_longest_edge_len() const
// Returns longest edge length
{
    return longest_edge_length;
}

const double& mesh::get_shortest_edge_len() const
// Returns shortest edge length
{
