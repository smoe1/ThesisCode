...
class mesh
{
    public:
        ...
        void InputMesh(string outputdir);
        ...
        const double& get_longest_edge_len() const;
        // Returns length of longest edge in entire domain

        const double& get_shortest_edge_len() const;
        // Returns length of shortest edge in entire domain
        ...
        // Sets the longest edge length for entire domain

        void set_shortest_edge_len(double len);
        // Sets the shortest edge length for entire domain
        ...
        void OutputSubMesh(string outputdir);
        void InputSubMesh(string inputdir);
        // ----------------------------------------------------------
    ...
    private:
        ...
        // length of shortest and longest edges in entire domain.
