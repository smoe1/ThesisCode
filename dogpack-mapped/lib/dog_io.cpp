...
// C-style file i/o (input-output) operations. For
// example, see $DOGPACK/DogSolver.cpp, where parameters.ini file gets copied to
// the output directory.cpp.

// Copy the contents of infile to outfile.
// Is there a higher-level system command to do a file copy? -DS
