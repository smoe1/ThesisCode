...
// This file is part of the parsing package.  These routines are used to check
// for default values, if they exist when parsing the parameters.ini file
// provided by each application.
//
// See also: $DOGPACK/lib/sys/IniDocument.cpp and 
//           $DOGPACK/lib/sys/IniDocument.h
