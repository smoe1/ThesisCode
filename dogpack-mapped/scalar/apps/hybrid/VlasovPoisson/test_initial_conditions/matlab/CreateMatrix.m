...
%CREATEMATRIX
%
% Usage: CREATEMATRIX(morder, showplots) creates the matrix for the elliptic
% problem with dirichlet boundary conditions.
%
% Input:
%
%    morder - order of the method.  This must match the value subfactor was
%    set to when setting up the grid.
%
%    showplots - flag indicating whether or not to show plots of the matrix
%    including sparsity and number of non-zeros.
%
%    showplots = 0:   do not show the plots
%              = 1:   show plots of the solution
%
