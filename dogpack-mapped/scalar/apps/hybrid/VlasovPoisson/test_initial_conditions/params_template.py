...
cflv(1)     = 0.25      ; max allowable Courant number 1/(2k-1) (for local problem)
cflv(2)     = 0.24      ; desired Courant number                (for local problem)
...
; -------------------------------------------------
[grid]
mx    =  5  ; number of grid elements in x-direction (do not refine here!)
my    =  5  ; number of grid elements in y-direction (do not refine here!)
