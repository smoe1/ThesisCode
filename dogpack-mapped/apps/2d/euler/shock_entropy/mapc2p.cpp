...
{
    double x=0.25*((1.0-xi)*(1.0-eta)*xp1+(1.0+xi)*(1.0-eta)*xp2+(1.0-xi)*(1.0+eta)*xp3+(1.0+xi)*(1.0+eta)*xp4);
    return x;
}

double mapy(double xi,double eta,double xp1,double xp2,double xp3,double xp4,double yp1,double yp2,double yp3,double yp4)
{
    double y=0.25*((1.0-xi)*(1.0-eta)*yp1+(1.0+xi)*(1.0-eta)*yp2+(1.0-xi)*(1.0+eta)*yp3+(1.0+xi)*(1.0+eta)*yp4);
    return y;
}
