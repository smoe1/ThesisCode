                            ...
                            dTensor1& Fr)
{
    ...
    //cout<<"nvec= "<<nvec.get(1)<<" "<<nvec.get(2)<<" "<<Auxl_tmp.get(1,1)<<" "<<Auxl_tmp.get(1,2)<<endl;
    for (int m=1; m<=2; m++)
...
//    if(Ql_tmp.get(1,1)>10.0)
//    {cout<<Ql_tmp.get(1,1)<<" "<<Auxl_tmp.get(1,1)<<" "<<Auxl_tmp.get(1,2)<<" ftmp! "<<ftmp.get(1,1,1)<<" "<<ftmp.get(1,1,2)<<endl;}
    for (int m=1; m<=meqn; m++)
