...
*/
            ...
            Pnow=(gamma-1.0e0)*(enow*rhonow-0.5*(mxnow*mxnow));
        ...
        avecell.set(i,5,(gamma-1.0e0)*(q.get(i,5,1)*q.get(i,1,1)-0.5*q.get(i,2,1)*q.get(i,2,1)));
    }
    ...
    {double thetae=1.0;
        ...
        thetamp=Max(0.0,thetamp);
        thetamp=Min(1.0,thetamp);
    ...
    //Nothing is being done with the previous stuff...ignore it
    //thetae=1.0;
