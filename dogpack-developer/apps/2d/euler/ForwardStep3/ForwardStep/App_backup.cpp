        ...
        dTensor2&))
{
    ...
    dTensorBC4 edgeval(mx,my,meqn,4,mbc);edgeval.setall(0.0e0);
    ...
    //for(int j=1-mbc; j <= my+mbc; j++)
    {
         ...
         for(int mp=1; mp <= mpoints; mp++)
         {
            ...
            {                             
                ...
                edgeval.set(i,j,1,1,edgeval.get(i,j,1,1)+rhonow*w1d.get(s));
                edgeval.set(i,j,2,1,edgeval.get(i,j,2,1)+mxnow*w1d.get(s));
                edgeval.set(i,j,3,1,edgeval.get(i,j,3,1)+mynow*w1d.get(s));
                edgeval.set(i,j,4,1,edgeval.get(i,j,4,1)+mznow*w1d.get(s));
                edgeval.set(i,j,5,1,edgeval.get(i,j,5,1)+enow*w1d.get(s));
                s=s+1;
                if(s>space_order){s=1;}
            }
            else if(mp>4+space_order && mp<=4+2*space_order)
            {
                edgeval.set(i,j,1,2,edgeval.get(i,j,1,2)+rhonow*w1d.get(s));
                edgeval.set(i,j,2,2,edgeval.get(i,j,2,2)+mxnow*w1d.get(s));
                edgeval.set(i,j,3,2,edgeval.get(i,j,3,2)+mynow*w1d.get(s));
                edgeval.set(i,j,4,2,edgeval.get(i,j,4,2)+mznow*w1d.get(s));
                edgeval.set(i,j,5,2,edgeval.get(i,j,5,2)+enow*w1d.get(s));
                s=s+1;
            ...
            {
                edgeval.set(i,j,1,3,edgeval.get(i,j,1,3)+rhonow*w1d.get(s));
                edgeval.set(i,j,2,3,edgeval.get(i,j,2,3)+mxnow*w1d.get(s));
                edgeval.set(i,j,3,3,edgeval.get(i,j,3,3)+mynow*w1d.get(s));
                edgeval.set(i,j,4,3,edgeval.get(i,j,4,3)+mznow*w1d.get(s));
                edgeval.set(i,j,5,3,edgeval.get(i,j,5,3)+enow*w1d.get(s));
                s=s+1;
                if(s>space_order){s=1;}
            } 
            else if (mp>4+3*space_order && mp<= 4+4*space_order)
            {
                edgeval.set(i,j,1,4,edgeval.get(i,j,1,4)+rhonow*w1d.get(s));
                edgeval.set(i,j,2,4,edgeval.get(i,j,2,4)+mxnow*w1d.get(s));
                edgeval.set(i,j,3,4,edgeval.get(i,j,3,4)+mynow*w1d.get(s));
                edgeval.set(i,j,4,4,edgeval.get(i,j,4,4)+mznow*w1d.get(s));
                edgeval.set(i,j,5,4,edgeval.get(i,j,5,4)+enow*w1d.get(s));
                s=s+1;
                if(s>space_order){s=1;}
            }
...
#pragma omp parallel for
    ...
    { 
    //cout<<"HERE1 "<<edgeval.get(i-1,j,me,2)-edgeval.get(i,j,me,1)<<endl;
    //cout<<"HERE2 "<<edgeval.get(i,j,me,2)-edgeval.get(i+1,j,me,1)<<endl;
    //cout<<"HERE3 "<<edgeval.get(i,j+1,me,3)-edgeval.get(i,j,me,4)<<endl;
    //cout<<"HERE4 "<<edgeval.get(i,j-1,me,4)-edgeval.get(i,j,me,3)<<endl;
    if(fabs(edgeval.get(i-1,j,me,2)-edgeval.get(i,j,me,1))>cutoff || fabs(edgeval.get(i,j,me,2)-edgeval.get(i+1,j,me,1))>cutoff || fabs(edgeval.get(i,j+1,me,3)-edgeval.get(i,j,me,4))>cutoff || fabs(edgeval.get(i,j-1,me,4)-edgeval.get(i,j,me,3))>cutoff)
