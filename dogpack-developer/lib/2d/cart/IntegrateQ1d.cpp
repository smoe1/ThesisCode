...
//
// That is, this routine evaluates the integral 
// \int q(x,y)\ dx OR \int q(x,y)\ dy depending on parameter mopt.
//
// Input:
// ------
//
...
{
    // Why was this wrapper inserted? Are we moving towards passing *everything*
    // through pointers in place of pass by reference? -DS
    void IntegrateQ1d(const int mopt, const dTensorBC4* q2d, dTensorBC3* q1d);
