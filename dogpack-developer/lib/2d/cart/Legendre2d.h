...
// Tensors used inside this class.  (Could include "tensors.h", but presumably
// this will compile faster ... )
//
class dTensor1;
class dTensor2;
class dTensor3;
...
void SetLegendre(const int mpoints1d, const dTensor2& spts, dTensor2& phi);
...
// This class is usually instantiated as a singleton.
//
// See also: edge_data (polynomials evaluated on the edge of the canonical
//                      element).
class Legendre2d
{
    ...
    private:
        ...
        // Positivity quadrature points and legendre polynomials evaluated at these
        // points.
        //
