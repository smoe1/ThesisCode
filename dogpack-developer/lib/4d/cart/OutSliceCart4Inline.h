...
//
namespace OutSliceCart4Inline
{

    inline void slice_q_local_1( const int kmax2d, const dTensor1& qin, dTensor1& qout)
    {
        switch(kmax2d)
        {
            case 10: // kmax=20
    ...
    inline void slice_q_local_2(const int kmax2d, const dTensor1& qin, dTensor1& qout)
    {
        switch(kmax2d)
        {
            case 10: // kmax=20
    ...
    inline void slice_q_local_3(const int kmax2d, const dTensor1& qin, dTensor1& qout)
    {
        switch(kmax2d)
        {
            case 10: // kmax=20
