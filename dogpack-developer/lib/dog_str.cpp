...
// C-style string operations.  I believe these are used for parsing and saving
// the parameters.ini files? (-DS).
//
// See also: dog_io.cpp
...
// delete [] int_array;
//
int new_array_from_str( const char* str_in, int* &int_array,
        int first_idx, char field_sep)
{
