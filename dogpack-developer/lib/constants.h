...
const double pi2   = 9.8696044010893586188;
const double pi3   = 3.1006276680299820175e+01;
const double opi   = 3.1830988618379067153e-01;
const double opi2  = 1.0132118364233777144e-01;
...
const double oneeleventh   = 9.0909090909090909091e-02;
const double onethirteenth = 7.6923076923076930769e-02;
const double onesixtyfirst = 1.6393442622950819672e-02;
