...
%s''' % main.__doc__)
    ...
    parser.add_option('-i', '--iterations', type='int', default=6, 
                       ...
                       Default = 6''')
    parser.add_option('-x', '--mx-start', type='int', default=12, 
                       help='''MX_START = number of grid points to start
                       computation with. Default = 12.''')
    parser.add_option('-t', '--dt-start', type='float', default=0.44,
                       help='''DT_START = starting dt value''')
    parser.add_option('-s', '--space-order', type='int', default=2,
                       help='''SPACE_ORDER = spatial order of accuracy. default = 2.''')
    parser.add_option('-z', '--h0-start', type='float', default=0.16,
                       help='''H0_START = starting value of h0.  Default = 0.16.''')
