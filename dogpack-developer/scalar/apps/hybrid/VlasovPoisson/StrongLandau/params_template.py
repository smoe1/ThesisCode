...
dtv(1)      = 0.0002    ; initial dt              (First step will always be thrown away)
...
xlow  = -7.5e0 ; left end point
xhigh =  7.5e0 ; right end point
ylow  = -7.5e0 ; lower end point
yhigh =  7.5e0 ; upper end point
'''
...
%(sorder)i            : Create a submesh with given integer refinement factor
----------------------------------------------------------------
Bounding box:
  0.0e0                : xmin
  12.566370614359172   : xmax
 -6.283185307179586    : ymin
  6.283185307179586    : ymax
----------------------------------------------------------------
4                     : Number of fixed points
----------------------------------------------------------------
Fixed points (x y):
  0.0e0                -6.283185307179586
