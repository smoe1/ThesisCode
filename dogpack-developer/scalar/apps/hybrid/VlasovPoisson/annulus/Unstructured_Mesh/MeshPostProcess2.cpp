...
void MeshPostProcess2(const string& GridType, mesh& Mesh, 
		      double (*SignedDistance)(point))
{
  ...
  double* mid_ghost = new double[NumGhostElems];
  double*  mid_phys = new double[NumGhostElems];
  int*       index1 = new int[NumGhostElems];
  int*       index2 = new int[NumGhostElems];
