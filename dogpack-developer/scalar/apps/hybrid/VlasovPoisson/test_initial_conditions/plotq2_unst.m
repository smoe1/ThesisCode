...
qex(:,2)      =  v1c*qex(:,1);              % 1-momentum
qex(:,3)      =  v2c*qex(:,1);              % 2-momentum
qex(:,4)      =  (v1c^2+s1^2)*qex(:,1);     % (1,1)-momentum
qex(:,5)      =  (v2c^2+s2^2)*qex(:,1);     % (2,2)-momentum
qex(:,6)      =  v1c*v2c*qex(:,1);          % (1,2)-momentum
