...
%    );
  ...
  elseif(strcmp(params.model_name,'g20'))
    params.model_string = '20-moment two-fluid Maxwell';
  elseif(strcmp(params.model_name,'g10'))
    params.model_string = '10-moment two-fluid Maxwell';
  elseif(strcmp(params.model_name,'g05'))
    params.model_string = '5-moment two-fluid Maxwell';
  elseif(strcmp(params.model_name,'p20'))
    params.model_string = '10-moment Maxwell symmetric pair plasma';
  elseif(strcmp(params.model_name,'p10'))
    params.model_string = '10-moment Maxwell symmetric pair plasma';
  elseif(strcmp(params.model_name,'p05'))
    params.model_string = '5-moment Maxwell symmetric pair plasma';
  elseif(strcmp(params.model_name,'i10e5'))
    params.model_string = '10-moment ions, 5-moment electrons, Maxwell';
