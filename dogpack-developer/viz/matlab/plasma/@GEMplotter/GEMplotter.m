...
function assert_stateVarMap_agree_with_varMap(stateVarMap, varMap)
  for i=1:length(stateVarMap.name_arr)
    ...
    if(~(varMap.size_s.(name) == stateVarMap.size_s.(name)))
      name
      varMap.size_s.(name)
      stateVarMap.size_s.(name)
    end
  end
end
...
function varMap = get_varMap(model_name)
  ...
  var_names_and_sizes = { ...
     ...
     'N',  6,  'nrg',  1, ...
     ... % gas state variables
     'rho_i', 1, 'Mi', 3, 'Ni', 6, 'QNi', 10, 'nrg_i', 1, ...
     'rho_e', 1, 'Me', 3, 'Ne', 6, 'QNe', 10, 'nrg_e', 1, ...
...
function bool = is_symmetric(model_name)
  bool = strcmp(model_name,'p20')...
       ||strcmp(model_name,'p10')...
       ||strcmp(model_name,'p05');
end
...
function display_names = make_display_names(varMap, params)
  ...
  display_names{varIdx_s.QNi   } = 'ion conserved heat moment';
  ...
  display_names{varIdx_s.QNe   } = 'electron conserved heat moment';
...
function output_scales = make_output_scales(varMap, params)
  ...
  output_scales(:,varIdx_s.QNi     ) = scale.Q_0;
  ...
  output_scales(:,varIdx_s.QNe     ) = scale.Q_0;
  ...
  output_scales(:,varIdx_s.P5i11   ) = scale.P_0;
  output_scales(:,varIdx_s.P5i22   ) = scale.P_0;
  output_scales(:,varIdx_s.P5i33   ) = scale.P_0;
  output_scales(:,varIdx_s.P5i12   ) = scale.P_0;
  output_scales(:,varIdx_s.P5i13   ) = scale.P_0;
  output_scales(:,varIdx_s.P5i23   ) = scale.P_0;
  output_scales(:,varIdx_s.P5e11   ) = scale.P_0;
  output_scales(:,varIdx_s.P5e22   ) = scale.P_0;
  output_scales(:,varIdx_s.P5e33   ) = scale.P_0;
  output_scales(:,varIdx_s.P5e12   ) = scale.P_0;
  output_scales(:,varIdx_s.P5e13   ) = scale.P_0;
  output_scales(:,varIdx_s.P5e23   ) = scale.P_0;
  output_scales(:,varIdx_s.Ti11    ) = scale.T_0;
  output_scales(:,varIdx_s.Ti22    ) = scale.T_0;
  output_scales(:,varIdx_s.Ti33    ) = scale.T_0;
  output_scales(:,varIdx_s.Ti12    ) = scale.T_0;
  output_scales(:,varIdx_s.Ti13    ) = scale.T_0;
  output_scales(:,varIdx_s.Ti23    ) = scale.T_0;
  output_scales(:,varIdx_s.Te11    ) = scale.T_0;
  output_scales(:,varIdx_s.Te22    ) = scale.T_0;
  output_scales(:,varIdx_s.Te33    ) = scale.T_0;
  output_scales(:,varIdx_s.Te12    ) = scale.T_0;
  output_scales(:,varIdx_s.Te13    ) = scale.T_0;
  output_scales(:,varIdx_s.Te23    ) = scale.T_0;
  output_scales(:,varIdx_s.QNi111  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNi122  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNi133  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNi112  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNi113  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNi123  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNi222  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNi223  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNi233  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNi333  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNe111  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNe122  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNe133  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNe112  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNe113  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNe123  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNe222  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNe223  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNe233  ) = scale.Q_0;
  output_scales(:,varIdx_s.QNe333  ) = scale.Q_0;
