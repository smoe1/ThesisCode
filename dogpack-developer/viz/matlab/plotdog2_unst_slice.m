function plotdog2_unst_slice(mr, points_per_dir, outputdir_in, point_type)
%PLOTDOG2_UNST_SLICE(points_per_dir, outputdir_in, points_per_dir )
%
% mr = number of points to plot along the slice.
%
...
if (GridType=='Cartesian   ')
  ...
  LegVals=GetCart2Legendre(kmax,points_per_dir,s2d);
  ...
  while(nf~=-1)
    ...
    if (nf~=-1)
      ...
      [q_data,time] = read_state2_cart(datafmt, outputdir, n1, 'q', ...
                                       ...
                                       1:meqn);
      qsoln = sample_state2_cart_mod(q_data, meth1, kmax, LegVals);
      clear q_data;
      ...
      if (maux>0)
        ...
        aux = sample_state2_cart_mod(a_data, meth1, kmax, LegVals);
        clear a_data;
...
elseif (GridType=='Unstructured')  
  ...
  LegVals = GetUnst2Legendre(kmax,points_per_dir,z);
  ...
  disp(' ');
      ...
      disp(' ');
      disp([' Error in plotdog2_unst_slice.m: GridType = ',GridType,' is not ' ...
                          'supported.']);
      disp(' ');
  end
