function plotdog4(points_per_dir,outputdir_in,point_type)
%PLOTDOG4(points_per_dir, outputdir_in, points_per_dir )
%
...
% TOOD - THIS IS HARD CODED FOR 4D-VLASOV!!! (-DS)
disp('Warning: setting meqn = 6. I assume you want to run 4D Vlasov?');
meqn = 6;
...
% kmax = get_kmax(meth1,ndims);
  ...
  while(nf~=-1)
    ...
    if (nf~=-1)
      ...
      %% Solution -- q
      [q_data,time] = read_state2_unst(datafmt, outputdir, n1, 'q2dUnst', ...
