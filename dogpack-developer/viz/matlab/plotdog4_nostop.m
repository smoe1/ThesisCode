function plotdog4_nostop(points_per_dir,outputdir_in,point_type)
%PLOTDOG4_NOSTOP(points_per_dir, outputdir_in, points_per_dir )
%
% This is the version of plotdog4 that automatically clicks through all of the
% frames.  (e.g., this is useful for creating movies of the simulation).
%
