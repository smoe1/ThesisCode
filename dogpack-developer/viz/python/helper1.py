...
def SampleBasis1(spts, kmax ):
    ...
    -----
        ...
        kmax   - maximum number of basis functions to be used.
        spts   - location of points (on canonical element) to be sampled.
                 spts[:] \in [-1,1].

    Returns
    -------

        phi   -  size(phi) = (numpts, kmax)
    """
...
def read_params(outputdir,params,qhelpname):
    """This routine has been deprecated in favor of parse_parameters, which
    directly accesses the parameters.ini file."""
